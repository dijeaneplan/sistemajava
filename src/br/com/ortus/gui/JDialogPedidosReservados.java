...
public class JDialogPedidosReservados extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel27.setText("Status Produção");
        ...
        jComboBoxRepresentante.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Juliana", "Tathiany", "Vanderleia", "Anatecia", "Ortiz", "Outro" }));
        ...
        jComboBoxStatusProducao.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Em Produção", "Produzido" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jComboBoxStatusProducao, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ortus/icones/printer.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ortus/icones/printer.png"))); // NOI18N
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ortus/icones/printer.png"))); // NOI18N
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/ortus/icones/printer.png"))); // NOI18N
    ...
    private void salvar() {
        if (!validarCampos()) {
            ...
            pedido.setDataEnvioPA(jComboBoxStatusProducao.getSelectedItem().toString());
...
//        }
    ...
    private void preencherFormularioComDados(PedidosReservados pedido) {
        ...
        jComboBoxStatusProducao.setSelectedIndex(pegarStatusProducao(pedido.getDataEnvioPA()));
    ...
    private void popularTabelaParaEnviar(boolean ordenar) {
        ...
        model.setColumnIdentifiers(new String[]{"Emissão", "Pedido", "Cliente", "Representante", "Biojato", "Bios. CB", "Bios. SB", "Soni I", "Soni II", "Led I", "Led II", "Kit Led", "Kit Ortusonic", "Kit Jato", "Envio", "Obs.", "Entrega PA", "Produzido?"});
...
//    }
    ...
    private int pegarStatusProducao(String dataEnvioPA) {
        int count = 0;
        while (count < jComboBoxStatusProducao.getItemCount()) {
            if (jComboBoxStatusProducao.getItemAt(count).toString().equals(dataEnvioPA)) {
                return count;
            }
            count++;

        }
        if(count>=jComboBoxStatusProducao.getItemCount()){
            count = 0;
        }
