...
public class JDialogPesquisaComponente extends javax.swing.JDialog {
    ...
    private void popularTabela() {
        ...
        model.setColumnIdentifiers(new String[]{
                    "ID", "Componente","U.M.", "Valor R$" });
        componentes = cDao.obterLista(filtro);
        
        if (componentes != null) {
            for (Componente comp : componentes) {
                model.addRow(new Object[]{comp.getIdProdusys(), comp.getNome(), comp.getUnidadeMedida(), new Utilidades().formatarValorDoubleParaString(comp.getQtde())});
            }
