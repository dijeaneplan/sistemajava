...
public class JDialogListagemPecasEPrecos extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jButtonPesquisa, javax.swing.GroupLayout.DEFAULT_SIZE, 240, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void popularTabela() {
        ...
        model.setColumnIdentifiers(new String[]{
            "Codigo", "Componente", "U.M.", "Valor Cliente Final R$", "Valor Técnico R$"});
        componentes = cDao.obterLista(filtro);

        if (componentes != null) {
            for (Componente comp : componentes) {
                model.addRow(new Object[]{comp.getIdProdusys(), comp.getNome(), comp.getUnidadeMedida(), new Utilidades().formatarValorDoubleParaString(comp.getValor()), new Utilidades().formatarValorDoubleParaString(comp.getQtde())});
            }
    ...
    private void imprimirRelatorio()  {
        ...
        try {            
                report.relatorioPronto("pecasTecnicos", "Preço de Peças");
