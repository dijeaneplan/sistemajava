...
public abstract class HibernateConfiguracao {
    ...
    private static String senhaBase = "";// sua seha de usuario da base de dados aqui
    private static String baseDados = "astec";// o nome da sua base de dados aqui
    private static String host = "localhost:3306"; // IP da maquina onde esta o banco de dados
    ...
    public static Session openConect() {
        if (cfg == null) {
            ...
            cfg.addAnnotatedClass(Expedicao.class);
            
            cfg.addAnnotatedClass(Autoclave.class);
            cfg.addAnnotatedClass(RegistroAutoclave.class);
